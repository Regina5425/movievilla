...
class ArrowSlider {
  ...
  clickArrow(e) {
    ...
    if (idArrow.match("right")) {
      ...
      buttonLeft = document.querySelector(
        "#slider" + numberSlider + "-arrow_left"
      );
    ...
    if (idArrow.match("left")) {
      ...
      buttonRight = document.querySelector(
        "#slider" + numberSlider + "-arrow_right"
      );
...
let slider1 = new ArrowSlider(
  "Top 250 Movies",
  "https://imdb-api.com/en/API/Top250Movies/k_4wflfh9z",
  "slider1"
);
slider1.render();
slider1.renderCards();
...
let slider2 = new ArrowSlider(
  "Top 250TVs",
  "https://imdb-api.com/en/API/Top250TVs/k_4wflfh9z",
  "slider2"
);
slider2.render();
slider2.renderCards();
...
let slider3 = new ArrowSlider(
  "In Theaters",
  "https://imdb-api.com/en/API/InTheaters/k_4wflfh9z",
  "slider3"
);
slider3.render();
slider3.renderCards();
